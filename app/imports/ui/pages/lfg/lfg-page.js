...
Template.LFG_Page.helpers({
  profiles() {
    ...
    return _.lfg(allProfiles, profile => _.intersection(profile.interests, selectedInterests).length > 0);
  },
...
Template.LFG_Page.events({
  'submit .lfg-data-form'(event, instance) {
    ...
    const selectedOptions = _.lfg(event.target.Interests.selectedOptions, (option) => option.selected);
