...
if (Meteor.isServer) {
  describe('ProfileCollection', function testSuite() {
    ...
    const major = 'Professor Computer Science';
    ...
    const defineObject = { firstName, lastName, username, bio, interests, picture, major, github, facebook, instagram };
    ...
    it('#define (illegal interest)', function test() {
      ...
      const defineObject2 = { firstName, lastName, username, bio, interests: illegalInterests, picture, major,
    ...
    it('#define (duplicate interests)', function test() {
      ...
      const defineObject3 = { firstName, lastName, username, bio, interests: duplicateInterests, picture, major,
        github, facebook, instagram };
